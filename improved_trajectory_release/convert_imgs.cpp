...
string listsrc  = "/share/vol2/home/xiaolonw/action_list/list4_clean/";
string videosrc = "/share/vol2/home/xiaolonw/action_videos/";
string saveDir = "/nfs.yoda/xiaolonw/ai2_action/action_frames4/";
char fname[1010];
...
int extractframes(char * videoname, vector<int> frameids, char * savePath)
{
	...
	while( clipnum * 2 < frameids.size() ) 
	{
		...
		while (frameNum <= endframe) 
		{
			...
			sprintf(filename, "%s/%07d.jpg", tsave, frameNum);
